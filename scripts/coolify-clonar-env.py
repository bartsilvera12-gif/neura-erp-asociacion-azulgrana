...
transformaciones que necesita el ERP de Asociación Hernandarias Azulgrana.
...
REGLAS (ver DEPLOY_ASOCIACIONAZULGRANA.md)
...
SCHEMA = "asociacionazulgranaerp"
APP_URL = "http://asociacionhernandariasazulgrana.neura.com.py"
