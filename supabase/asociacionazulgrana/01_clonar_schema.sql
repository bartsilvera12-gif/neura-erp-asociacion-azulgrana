-- =============================================================================
-- 01 · CLON ESTRUCTURAL COMPLETO  instemaq  →  asociacionazulgranaerp
-- =============================================================================
...
--   · Solo hace CREATE dentro de `asociacionazulgranaerp`. No toca `public`,
...
--   · Aborta si `asociacionazulgranaerp` ya existe (no pisa nada).
--
...
DECLARE
  ...
  v_tgt  text := 'asociacionazulgranaerp';  -- destino (no cambiar)
  ---------------------------------------------------------------------------
  v_tables  text[];
