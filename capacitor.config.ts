...
const config = {
  ...
  server: {
    ...
    url: "http://asociacionhernandariasazulgrana.neura.com.py/m/asesor",
    cleartext: true,
    allowNavigation: ["asociacionhernandariasazulgrana.neura.com.py", "*.neura.com.py", "api.neura.com.py"],
  },
  plugins: {
    PushNotifications: {
